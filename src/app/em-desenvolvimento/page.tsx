    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className="text-center max-w-2xl mx-auto px-4">
        ...
        <p className="text-xl text-gray-300 mb-8 leading-relaxed">
          Esta seção está sendo desenvolvida para mostrar mangás em produção ativa. 
          Em breve você poderá acompanhar o progresso dos seus mangás favoritos!
        </p>
        ...
        <div className="bg-gray-800 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
            ...
            <div className="flex items-center gap-3 text-gray-300">
              <span className="text-2xl">📊</span>
              <span>Estatísticas de desenvolvimento</span>
            </div>
            <div className="flex items-center gap-3 text-gray-300">
              <span className="text-2xl">⏰</span>
              <span>Previsões de lançamento</span>
            </div>
          </div>
        </div>
